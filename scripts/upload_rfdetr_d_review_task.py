"""Create a separate CVAT review task for the full RF-DETR train_D run."""
...
DEFAULT_ARCHIVE_PATH = (
    ...
    / "My Artifacts"
    / "cvat_import"
    / "train_D_rfdetr_deduplicated_v3_coco.zip"
)
PROJECT_NAME = "Vehicle pseudo-label review - prediction_tree v6"
TASK_NAME = "train_D - validation - RF-DETR deduplicated v3"
